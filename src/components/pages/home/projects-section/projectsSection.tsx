...
export function ProjectsSection() {
  return (
    <section id="projetos" className="py-16 md:py-24 px-4 bg-[var(--cor-escuro-1)]">
      <div className="max-w-7xl mx-auto">
        <div className=" md:flex justify-between mb-6 md:mb-12">
          ...
          <a href="/projetos" className="inline-flex flex items-center gap-1 text-[var(--cor-branco)] bg-[var(--cor-escuro-3)] border border-[var(--cor-escuro-4)] hover:bg-[var(--cor-escuro-4)] py-3 px-8 rounded-full hover:scale-105 hover:shadow-2xl transition">Ver todos <ArrowUpRight className="w-4 h-4" /></a>
        </div>
