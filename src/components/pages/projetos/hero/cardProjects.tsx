      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              className="p-4 bg-gradient-to-br from-[var(--cor-escuro-6)] via-[var(--cor-escuro-6)] to-[var(--cor-escuro-4)] rounded-lg flex flex-col h-full"
              key={project.name}
            >
              <img
                src={project.image}
              ...
              <div className="flex gap-3 mt-auto">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white text-black border text-sm font-medium rounded-full hover:bg-white/90 transition-colors"
                >
